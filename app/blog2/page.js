...
export default function Home() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={10} footerStyle={10} breadcrumbTitle="Blog Grid 2">
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-auhtor2-text margin-b30 ">
                                        <div className="blog2-ahtuor2 blog2inner">
                                            ...
                                            <Link href="/blogmiddle">
                                                <h1 className="font-20 font-lora color-17 lineh-20 weight-600 margin-b14">Bussiness
                                    ...
                                    <div className="blog-auhtor2-text ">
                                        <div className="blog2-ahtuor2 blog2inner">
                                            ...
                                            <Link href="/blogmiddle">
                                                <h1 className="font-20 font-outfit color-17 lineh-20 weight-600 margin-b14">Organizational
