...
export default function Home() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={10} footerStyle={10} breadcrumbTitle="Blog Right">
                <div className="blogleft-section-area section-padding5">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="blogleftinner3-area">
                                    <img src="/assets/images/sectionimg/blogleftimg1.png" alt="" className="w-100 innerimg" />
                                    <div className="afteralex-area">
                                        ...
                                        <div className="alex">
                                            ...
                                            <Link href="#" className="font-16 lineh-16 font-ks weight-500 color-29">05 Jun 2023</Link>
                                        </div>
                                        <div className="alex">
                                            ...
                                            <div className="repl-boxarea">
                                                ...
                                                <div className="reply-text">
                                                    ...
                                                    <Link href="#" className="color-30">
                                                        <p className="font-ks font-16 lineh-26 weight-500 color-30">08 Jan 2023</p>
                                                    </Link>
                                                </div>
                                            </div>
                                            <Link href="#"><span className="font-ks font-16 weight-600 color-29 lineh-20"><i className="fa-solid fa-reply" />Reply</span></Link>
                                        </div>
                            ...
                            <div className="col-lg-4">
                                <div className="secrch-areacase margin-b30">
                                    <h1 className="font-24 lineh-24 weight-600 color-29  font-lora margin-b24">Search</h1>
                                    <form>
                                        <div className="caseinput-area">
                                ...
                                <div className="serviceour-area">
                                    <h1 className="font-lora font-24 lineh-24 weight-600 color-29 margin-b24">Blog Categories</h1>
                                    ...
                                    <div className="singlepalnning-area margin-b20">
                                        <Link href="#" className="font-18 font-ks lineh-18 weight-600 color-29 ts">Financial Planning</Link>
                                        <span><i className="fa-solid fa-angle-right ts" /></span>
                                    </div>
                                    <div className="singlepalnning-area margin-b20">
                                        <Link href="#" className="font-18 font-ks lineh-18 weight-600 color-29 ts">Best Marketing
                                            Analysis</Link>
                                        <span><i className="fa-solid fa-angle-right ts" /></span>
                                    </div>
                                    <div className="singlepalnning-area margin-b20">
                                        <Link href="#" className="font-18 font-ks lineh-18 weight-600 color-29 ts">Tax Managment Plan</Link>
                                        <span><i className="fa-solid fa-angle-right ts" /></span>
                                    </div>
                                    <div className="singlepalnning-area margin-b20">
                                        <Link href="#" className="font-18 font-ks lineh-18 weight-600 color-29 ts">Estate Planning</Link>
                                        <span><i className="fa-solid fa-angle-right ts" /></span>
                                    </div>
                                    <div className="singlepalnning-area margin-b20">
                                        <Link href="#" className="font-18 font-ks lineh-18 weight-600 color-29 ts">Invesment Managmentt</Link>
                                        <span><i className="fa-solid fa-angle-right ts" /></span>
                                    </div>
                                </div>
                                <div className="recenrblos-area">
                                    <h1 className="font-24 lineh-24 weight-600 color-29  font-lora margin-b24">Recent Blogs</h1>
                                    <div className="recentblog-text margin-b40">
                                        <div className="recent-images">
                                            <img src="/assets/images/sectionimg/recent1.png" alt="" />
                                        </div>
                                        <div className="recentblogsall">
                                            <div className="blog-date-list margin-b12">
                                                <img src="/assets/images/icons/daterane.png" alt="" />
                                                <Link href="#" className="font-16 lineh-16 font-ks weight-600 color-29">05 Nov 2023</Link>
                                            </div>
                                            <h1 className="font-16 lineh-24 weight-600 color-29 font-ks"><Link href="/blogmiddle" className="color-29 ts">Identify  implement the right technological solutions</Link>
                                            </h1>
                                        </div>
                                    </div>
                                    <div className="recentblog-text margin-b40">
                                        <div className="recent-images">
                                            <img src="/assets/images/sectionimg/recent2.png" alt="" />
                                        </div>
                                        <div className="recentblogsall">
                                            <div className="blog-date-list margin-b12">
                                                <img src="/assets/images/icons/daterane.png" alt="" />
                                                <Link href="#" className="font-16 lineh-16 font-ks weight-600 color-29">14 Jun 2023</Link>
                                            </div>
                                            <h1 className="font-16 lineh-24 weight-600 color-29 font-ks"><Link href="/blogmiddle" className="color-29 ts">Identify  implement the right technological solutions</Link>
                                            </h1>
                                        </div>
                                    ...
                                    <div className="recentblog-text margin-b40">
                                        <div className="recent-images">
                                            <img src="/assets/images/sectionimg/recent3.png" alt="" />
                                        </div>
                                        <div className="recentblogsall">
                                            <div className="blog-date-list margin-b12">
                                                <img src="/assets/images/icons/daterane.png" alt="" />
                                                <Link href="#" className="font-16 lineh-16 font-ks weight-600 color-29">23 May 2023</Link>
                                            </div>
                                            <h1 className="font-16 lineh-24 weight-600 color-29 font-ks"><Link href="/blogmiddle" className="color-29 ts">Identify  implement the right technological solutions</Link>
                                            </h1>
                                        </div>
                                    </div>
                                    <div className="recentblog-text margin-b20">
                                        <div className="recent-images">
                                            <img src="/assets/images/sectionimg/recent4.png" alt="" />
                                        </div>
                                        <div className="recentblogsall">
                                            <div className="blog-date-list margin-b12">
                                                <img src="/assets/images/icons/daterane.png" alt="" />
                                                <Link href="#" className="font-16 lineh-16 font-ks weight-600 color-29"> 05 Jan 2023</Link>
                                            </div>
                                            <h1 className="font-16 lineh-24 weight-600 color-29 font-ks"><Link href="/blogmiddle" className="color-29 ts">Identify  implement the right technological solutions</Link>
                                            </h1>
                                        </div>
                                ...
                                <div className="tags-area margin-t32">
                                    <h1 className="font-24 lineh-24 weight-600 color-29  font-lora margin-b24">Popular Tags</h1>
                                    <ul>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29 m-0">Consulting</Link></li>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29">Business</Link></li>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29">Finance</Link></li>
                                    </ul>
                                    <ul>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29 m-0">Business
                                            Evaluation</Link></li>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29">Advice Business</Link>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29 m-0">Consulting
                                            Process</Link></li>
                                        <li><Link href="#" className="font-ks font-16 lineh-26 weight-500 color-29">Marketing</Link></li>
                                    </ul>
                                </div>
                                <div className="author-area">
                                    <h1 className="font-24 lineh-24 weight-600 color-29  font-lora margin-b24">Our Author</h1>
                                    <ul>
                                        <li className="m-0"><img src="/assets/images/sectionimg/author1.png" alt="" className="m-0" /></li>
                                        <li><img src="/assets/images/sectionimg/author2.png" alt="" /></li>
                                        <li><img src="/assets/images/sectionimg/author3.png" alt="" /></li>
                                        <li><img src="/assets/images/sectionimg/author4.png" alt="" /></li>
                                    </ul>
                                </div>
                                <div className="needed-section">
                                    <h1 className="font-lora font-24 lineh-30 weight-600 color-29 margin-b24">If You Need Any Help
                                        Contact With Us</h1>
                                    <Link href="/tel:+917052101786" className="font-16 weight-700 color fon-ks lineh-16"><img src="/assets/images/icons/phone9.svg" alt="" />+91 705 2101 786</Link>
                                </div>
                            </div>
                        </div>
                    </div>
