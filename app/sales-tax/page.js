  ...
  return (
    <>
      <Layout
        headerStyle={10}
        footerStyle={10}
        breadcrumbTitle="Sales Tax Services"
      >
        <div>
                ...
                <div className="col-lg-7 m-auto">
                  <div className="servicev1-textarea margin-b60 text-center">
                    <h1 className="font-48 font-lora weight-600 color-29 lineh-56">
                      Sales Tax and Use Tax Services to Keep Your Business
                      Compliant
                    </h1>
                  </div>
                </div>
                      ...
                      <div className="col-lg-6">
                        <div className="service3-imag1">
                          <img
                            ...
                            alt="Sales Tax Audit Assistance"
                          />
                        </div>
                      </div>
                    </div>
