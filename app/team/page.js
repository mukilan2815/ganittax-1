...
export default function Home() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={10} footerStyle={10} breadcrumbTitle="Our Team">
                <div>
                            ...
                            <div className="row">
                                    ...
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                ...
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Educational Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                ...
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Technology Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team5.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Jean Lockman</Link></h1>
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Technology Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team7.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team8.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Mrs. Enrique Welch</Link></h1>
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Educational Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team9.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Marie D'Amore</Link></h1>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team10.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Cecil Carter Jr.</Link></h1>
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Nonprofit Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team11.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Jacquelyn Connelly</Link></h1>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            <div className="project-thumb-two">
                                                <img src="/assets/images/sectionimg/team12.png" alt="" />
                                            </div>
                                            <div className="project-content-two">
                                                <ul>
                                                    <li><Link href="#"><i className="fa-brands fa-x-twitter" />
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Lynne Schowalter</Link></h1>
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Educational Consultants</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-3 margin-b30">
                                    <div className="teaminner-section">
                                        <div className="project-item-two">
                                            ...
                                            <div className="team-pera text-center margin-t">
                                                <h1 className="font-lora font-24 lineh-24 color-29 weight-600 margin-b12"><Link href="/team" className="color-29">Marianne Beatty</Link></h1>
                                                <p className="font-16 lineh-16 weight-500 color-30 font-ks">Subject Matter Experts</p>
                                            </div>
                                        </div>
                                    </div>
