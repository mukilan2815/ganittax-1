                    ...
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="testimonial10-header text-center margin-b60">
                                ...
                                <h1 className="font-44 lineh-54 weight-600 colorhp3 font-lora margin-b24s">Client Feedback</h1>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                            ...
                            <Swiper {...swiperOptions} className="testimonial10-owlcarousel owl-carousel">
                                <SwiperSlide className="testimonial10-boxarea">
                                    <div className="testimonial10-allarea">
                                        ...
                                        <p className="font-18 weight-600 colorhp3 lineh-28 font-ks">Ganit Tax Inc. helped us streamline our bookkeeping and optimize our tax strategy.</p>
                                    ...
                                    <div className="mans-testimonial10">
                                        ...
                                        <h1> <Link href="#" className="font-18 weight-600 colorhp3 font-ks d-inline-block margin-b14">Rodrygo De Paul</Link></h1>
                                        <p>CEO, Paul Ltd</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="testimonial10-boxarea">
                                    <div className="testimonial10-allarea">
                                        ...
                                        <p className="font-18 weight-600 colorhp3 lineh-28 font-ks">They simplified my taxes and helped me file accurately and on time.</p>
                                        <img src="/assets/images/background/plygon1.png" alt="" className="polugonimages" />
                                    </div>
                                    <div className="mans-testimonial10">
                                        <div className="images10area">
                                        ...
                                        <h1> <Link href="#" className="font-18 weight-600 colorhp3 font-ks d-inline-block margin-b14">Sarah Johnson</Link></h1>
                                        <p>Entrepreneur</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="testimonial10-boxarea">
                                    <div className="testimonial10-allarea">
                                        ...
                                        <p className="font-18 weight-600 colorhp3 lineh-28 font-ks">Great service! Ganit Tax Inc. managed our payroll and saved us countless hours.</p>
                                        <img src="/assets/images/background/plygon1.png" alt="" className="polugonimages" />
                                    </div>
                                    <div className="mans-testimonial10">
                                        <div className="images10area">
                                        ...
                                        <h1> <Link href="#" className="font-18 weight-600 colorhp3 font-ks d-inline-block margin-b14">James Smith</Link></h1>
                                        <p>Owner, Smith Enterprises</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="testimonial10-boxarea">
                                    <div className="testimonial10-allarea">
